...
def make_fair_dice(sides):
    ...
    assert type(sides) == int and sides >= 1, 'Illegal value for sides' #type()function
    def dice():                                                      #returns object's type
        return randint(1,sides) #returns a random integer N between 1 and sides
    return dice
